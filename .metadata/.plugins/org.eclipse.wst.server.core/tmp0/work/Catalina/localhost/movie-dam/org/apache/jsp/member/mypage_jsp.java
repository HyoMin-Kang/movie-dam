 ...
 * Generated at: 2018-09-10 11:54:17 UTC
...
return;
	...
	String title = "마이페이지";
      ...
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"mypage.html\">프로필</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"active_individual.html\">활동</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"message.html\">메시지</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"setting.html\">설정</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<span><a class=\"btn btn-default\" href=\"active_friend.html\" role=\"button\">팔로우</a></span> \r\n");
      out.write("\t\t\t\t\t\t\t<span><a class=\"btn btn-default\" href=\"active_friend_following.html\" role=\"button\">팔로잉</a></span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\">프로필<span class=\"caret\"></span></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li class=\"nav\"><a href=\"setting.html\" role=\"button\" aria-expanded=\"false\">설정</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th scope=\"row\">나이</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>내용이 들어갑니다.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th scope=\"row\">커뮤니티 글 작성</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>내용이 들어갑니다.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th scope=\"row\">커뮤니티 답변 작성</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>내용이 들어갑니다.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\r\n");

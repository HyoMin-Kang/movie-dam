 ...
 * Generated at: 2018-09-10 13:43:24 UTC
...
return;
	...
	String title = "ㅇㅇㅇ님의 프로필";
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- Contact Me Start -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"post-title margin-top-5\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<h2>메시지 보내기</h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"textarea-message form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea id=\"message\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"textarea-message form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Your Message\" rows=\"5\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"load-more-button\">Send</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<footer>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul class=\"menu-link\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/movie-dam/member/profile.jsp\">프로필</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\">활동</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\">메시지</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/movie-dam/member/profile_setting.jsp\">설정</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<p>© 영화담</p>\r\n");
      out.write("\t\t\t\t\t\t\t</footer>\r\n");

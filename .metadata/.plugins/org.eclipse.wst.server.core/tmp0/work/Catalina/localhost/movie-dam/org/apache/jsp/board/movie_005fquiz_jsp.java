 ...
 * Generated at: 2018-09-13 15:31:30 UTC
...
return;
	...
	String title = "영화 퀴즈";
      ...
      out.write("\t\t\t\t\t\t\t\t<u>영화퀴즈</u>\r\n");
      out.write("\t\t\t\t\t\t\t</h2>\r\n");
      out.write("\t\t\t\t\t\t\t<br> <small>매주 새로운 퀴즈가 여러분을 기다립니다. 퀴즈를 푼 뒤 응모하기 버튼을 눌러주세요. 정답을 맞추신 한 명의 당첨자께 소정의 선물을 드립니다.</small>\r\n");
      out.write("\t\t\t\t\t\t\t<h3 align=\"center\">2018년 8월 31일</h3>\r\n");
      out.write("\t\t\t\t\t\t\t<form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>1. 다음 영화에서 삼차사의 세 번째 귀인이 된 인물은 누구인가?</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"float: left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"/movie-dam/assets/images/pic/god.jpg\" class=\"img-responsive\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\talt=\"Responsive image\" width=\"150\" height=\"300\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group margin-top-50\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"InputGender\">2. 신과 함께: 인과 연은 2018년 8월 1일에\r\n");
      out.write("\t\t\t\t\t\t\t\t\t개봉했다.</label>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"radio-inline\"> <input type=\"radio\"\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"inlineRadioOptions\" id=\"inlineRadio1\" value=\"option1\">\r\n");
      out.write("\t\t\t\t\t\t\t\tO\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group margin-top-50\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label>3. 신과 함께에서 염라대왕 역을 맡은 인물은?</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"float: left;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<p>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 100px\">응모하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");

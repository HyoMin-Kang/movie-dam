 ...
 * Generated at: 2018-09-15 15:50:50 UTC
...
public final class debate_005fbattle_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	String title = "찬반 토론";
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>\"홍대 누드모델 사건을 재수사 해야한다.\"</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</blockquote>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"carousel-info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<img alt=\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"http://keenthemes.com/assets/bootsnipp/img1-small.jpg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"pull-left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"pull-left\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"testimonials-people\">참여 인원 [x]</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-sm\">더보기</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h1>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<blockquote>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>\"혜화역 시위를 계속해도 되는가?\"</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</blockquote>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"carousel-info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<img alt=\"\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h1>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<blockquote>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p>\"성직자에게도 세금을 납부하게 해야한다.\"</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</blockquote>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"carousel-info\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<img alt=\"\"\r\n");

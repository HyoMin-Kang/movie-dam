					...
					<div class="row">
						...
						<div class="col-md-12 content-page">
							<ul class="nav nav-tabs nav-justified">
								<li role="presentation" class="active"><a href="./profile_follower.jsp">팔로워</a></li>
								<li role="presentation"><a href="./profile_following.jsp">팔로잉</a></li>
							</ul>
								...
								<div class="col-sm-6 col-md-4">
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>친구설명</p>
											<p>
												<a href="#" class="btn btn-default" role="button">팔로우</a>
											</p>
										</div>
									</div>
								</div>

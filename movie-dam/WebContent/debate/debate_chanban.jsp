		...
		<div class="row">
			<div class="col-12">
				<div class="section-heading dark text-center">
					...
					<p>영화를 주제로 한 다양한 찬반 토론 <%=count%>개가 진행중입니다.
					</p> <br>
				</div>
			</div>
		</div>
 ...
 %>
							<div class="media-body">
								...
								<div class="pro-con-icon">
									<span id="pros"><i class="fas fa-thumbs-up fa-sm" style="color: #4374D9;"></i> 찬성 <%=procount%>&nbsp;&nbsp;</span> <span id="cons"><i class="fas fa-thumbs-down fa-sm" style="color: #DF4D4D;"></i> 반대 <%=concount%>&nbsp;&nbsp;</span> <span id="opinion"><i class="fas fa-comments fa-sm"></i> 의견 <%=ccount%></span>
								</div>
							</div>
						</li>
					</ul>
				...
				<ul class="pagination justify-content-center">
					...
					<%
								...
								for (int i = startPage; i <= endPage; i++) {
									if (i == currentPage) {
					%>
					<li class="page-item active"><a class="page-link" href="debate_chanban.jsp?pageNum=<%=i%>"><%=i%><span class="sr-only">(current)</span>
						</a></li>
					<%
						} else {
					%>

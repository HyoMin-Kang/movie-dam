...
<div class="container">
	...
	<div class="row justify-content-center mb-4">
		<div class="btn-group btn-group-toggle" data-toggle="buttons">
			<label class="btn btn-outline-secondary"> <input type="checkbox" checked="checked" autocomplete="off">CGV</label> 
			<label class="btn btn-outline-secondary"> <input type="checkbox" checked="checked" autocomplete="off">롯데시네마</label> 
			<label class="btn btn-outline-secondary"> <input type="checkbox" checked="checked" autocomplete="off">메가박스</label>
		</div>
	</div>
...
%>
		<div class="col-12 col-sm-6 col-lg-4">
			<div class="single-features-area mb-50">
			    <a href="<%=preview.getOriginal_url()%>"><img src="/movie-dam/imageFolder/movie_preview/<%=preview.getArticle_file() %>" alt="preview_img"></a>
		        <div class="feature-content d-flex align-items-center justify-content-between">
		            <div class="feature-title">
		            	<a href="#"><span class="badge badge-pill badge-primary"><%=preview.getCinema()%></span></a>

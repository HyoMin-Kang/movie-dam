						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<select class="form-control" id="inputCategory" name="category">
									<option value="talk" <%if (article.getCategory().equals("talk")) {
					out.print(" selected=\"selected\"");
				}%>>사담</option>
									<option value="movietalk" <%if (article.getCategory().equals("movietalk")) {
					out.print(" selected=\"selected\"");
				}%>>영화후기</option>
									<option value="spoiler" <%if (article.getCategory().equals("spoiler")) {
					out.print(" selected=\"selected\"");
				}%>>스포일러</option>
									<option value="movietmi" <%if (article.getCategory().equals("movietmi")) {
					out.print(" selected=\"selected\"");
				}%>>영화TMI</option>
									<option value="boast" <%if (article.getCategory().equals("boast")) {
					out.print(" selected=\"selected\"");
				}%>>자랑하기</option>
									<option value="hobby" <%if (article.getCategory().equals("hobby")) {
					out.print(" selected=\"selected\"");
				}%>>덕질공간</option>
								</select>
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" id="inputFile" name="article_file" aria-describedby="fileHelp" accept="image/*"> <small id="fileHelp" class="form-text text-muted">이미지 파일만 첨부 가능합니다.</small>
							</div>
						</div>
					</c:if>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<select class="form-control" id="inputTheater" name="theater">
									<option value="cgv" <%if (restaurant.getTheater().equals("cgv")) {
					out.print(" selected=\"selected\"");
				}%>>CGV</option>
									<option value="롯데시네마" <%if (restaurant.getTheater().equals("롯데시네마")) {
					out.print(" selected=\"selected\"");
				}%>>롯데시네마</option>
									<option value="메가박스" <%if (restaurant.getTheater().equals("메가박스")) {
					out.print(" selected=\"selected\"");
				}%>>메가박스</option>
									<option value="대한극장" <%if (restaurant.getTheater().equals("대한극장")) {
					out.print(" selected=\"selected\"");
				}%>>대한극장</option>
									<option value="서울극장" <%if (restaurant.getTheater().equals("서울극장")) {
					out.print(" selected=\"selected\"");
				}%>>서울극장</option>
									<option value="etc" <%if (restaurant.getTheater().equals("etc")) {
					out.print(" selected=\"selected\"");
				}%>>ETC</option>
								</select>
							</div>
							<div class="col-sm-6">
								<select class="form-control" id="inputArea" name="area">
									<optgroup label="[서울]">
										<option value="강남점" <%if (restaurant.getArea().equals("강남점")) {
					out.print(" selected=\"selected\"");
				}%>>강남점</option>
										<option value="강변점" <%if (restaurant.getArea().equals("강변점")) {
					out.print(" selected=\"selected\"");
				}%>>강변점</option>
										<option value="건대입구점" <%if (restaurant.getArea().equals("건대입구점")) {
					out.print(" selected=\"selected\"");
				}%>>건대입구점</option>
										<option value="구로점" <%if (restaurant.getArea().equals("구로점")) {
					out.print(" selected=\"selected\"");
				}%>>구로점</option>
										<option value="대학로점" <%if (restaurant.getArea().equals("대학로점")) {
					out.print(" selected=\"selected\"");
				}%>>대학로점</option>
										<option value="동대문점" <%if (restaurant.getArea().equals("동대문점")) {
					out.print(" selected=\"selected\"");
				}%>>동대문점</option>
										<option value="명동점" <%if (restaurant.getArea().equals("명동점")) {
					out.print(" selected=\"selected\"");
				}%>>명동점</option>
										<option value="목동점" <%if (restaurant.getArea().equals("목동점")) {
					out.print(" selected=\"selected\"");
				}%>>목동점</option>
										<option value="미아점" <%if (restaurant.getArea().equals("미아점")) {
					out.print(" selected=\"selected\"");
				}%>>미아점</option>
										<option value="불광점" <%if (restaurant.getArea().equals("불광점")) {
					out.print(" selected=\"selected\"");
				}%>>불광점</option>
										<option value="상봉점" <%if (restaurant.getArea().equals("상봉점")) {
					out.print(" selected=\"selected\"");
				}%>>상봉점</option>
										<option value="성신여대점" <%if (restaurant.getArea().equals("성신여대점")) {
					out.print(" selected=\"selected\"");
				}%>>상봉점</option>
										<option value="송파점" <%if (restaurant.getArea().equals("송파점")) {
					out.print(" selected=\"selected\"");
				}%>>송파점</option>
										<option value="수유점" <%if (restaurant.getArea().equals("수유점")) {
					out.print(" selected=\"selected\"");
				}%>>수유점</option>
										<option value="신촌점" <%if (restaurant.getArea().equals("신촌점")) {
					out.print(" selected=\"selected\"");
				}%>>신촌점</option>
										<option value="압구정점" <%if (restaurant.getArea().equals("압구정점")) {
					out.print(" selected=\"selected\"");
				}%>>압구정점</option>
										<option value="여의도점" <%if (restaurant.getArea().equals("여의도점")) {
					out.print(" selected=\"selected\"");
				}%>>여의도점</option>
										<option value="영등포점" <%if (restaurant.getArea().equals("영등포점")) {
					out.print(" selected=\"selected\"");
				}%>>영등포점</option>
										<option value="왕십리점" <%if (restaurant.getArea().equals("왕십리점")) {
					out.print(" selected=\"selected\"");
				}%>>왕십리점</option>
										<option value="용산점" <%if (restaurant.getArea().equals("용산점")) {
					out.print(" selected=\"selected\"");
				}%>>용산점</option>
										<option value="중계점" <%if (restaurant.getArea().equals("중계점")) {
					out.print(" selected=\"selected\"");
				}%>>중계점</option>
										<option value="천호점" <%if (restaurant.getArea().equals("천호점")) {
					out.print(" selected=\"selected\"");
				}%>>천호점</option>
										<option value="청담점" <%if (restaurant.getArea().equals("청담점")) {
					out.print(" selected=\"selected\"");
				}%>>청담점</option>
										<option value="피카디리점" <%if (restaurant.getArea().equals("피카디리점")) {
					out.print(" selected=\"selected\"");
				}%>>피카디리점</option>
										<option value="하계점" <%if (restaurant.getArea().equals("하계점")) {
					out.print(" selected=\"selected\"");
				}%>>하계점</option>
										<option value="홍대점" <%if (restaurant.getArea().equals("홍대점")) {
					out.print(" selected=\"selected\"");
				}%>>홍대점</option>
									</optgroup>
									<optgroup label="[경기]">
										<option value="경기광주점" <%if (restaurant.getArea().equals("경기광주점")) {
					out.print(" selected=\"selected\"");
				}%>>경기광주점</option>
										<option value="광교상현점" <%if (restaurant.getArea().equals("광교상현점")) {
					out.print(" selected=\"selected\"");
				}%>>광교상현점</option>
										<option value="광명철산점" <%if (restaurant.getArea().equals("광명철산점")) {
					out.print(" selected=\"selected\"");
				}%>>광명철산점</option>
										<option value="구리점" <%if (restaurant.getArea().equals("구리점")) {
					out.print(" selected=\"selected\"");
				}%>>구리점</option>
										<option value="김포점" <%if (restaurant.getArea().equals("김포점")) {
					out.print(" selected=\"selected\"");
				}%>>김포점</option>
										<option value="동백점" <%if (restaurant.getArea().equals("동백점")) {
					out.print(" selected=\"selected\"");
				}%>>동백점</option>
										<option value="동수원점" <%if (restaurant.getArea().equals("동수원점")) {
					out.print(" selected=\"selected\"");
				}%>>동수원점</option>
										<option value="동탄점" <%if (restaurant.getArea().equals("동탄점")) {
					out.print(" selected=\"selected\"");
				}%>>동탄점</option>
										<option value="배곧점" <%if (restaurant.getArea().equals("배곧점")) {
					out.print(" selected=\"selected\"");
				}%>>배곧점</option>
										<option value="범계점" <%if (restaurant.getArea().equals("범계점")) {
					out.print(" selected=\"selected\"");
				}%>>범계점</option>
										<option value="부천점" <%if (restaurant.getArea().equals("부천점")) {
					out.print(" selected=\"selected\"");
				}%>>부천점</option>
										<option value="부천역점" <%if (restaurant.getArea().equals("부천역점")) {
					out.print(" selected=\"selected\"");
				}%>>부천역점</option>
										<option value="북수원점" <%if (restaurant.getArea().equals("북수원점")) {
					out.print(" selected=\"selected\"");
				}%>>북수원점</option>
										<option value="산본점" <%if (restaurant.getArea().equals("산본점")) {
					out.print(" selected=\"selected\"");
				}%>>산본점</option>
										<option value="소풍점" <%if (restaurant.getArea().equals("소풍점")) {
					out.print(" selected=\"selected\"");
				}%>>소풍점</option>
										<option value="수원점" <%if (restaurant.getArea().equals("수원점")) {
					out.print(" selected=\"selected\"");
				}%>>수원점</option>
										<option value="시흥점" <%if (restaurant.getArea().equals("시흥점")) {
					out.print(" selected=\"selected\"");
				}%>>시흥점</option>
										<option value="안산점" <%if (restaurant.getArea().equals("안산점")) {
					out.print(" selected=\"selected\"");
				}%>>안산점</option>
										<option value="안성점" <%if (restaurant.getArea().equals("안성점")) {
					out.print(" selected=\"selected\"");
				}%>>안성점</option>
										<option value="역곡점" <%if (restaurant.getArea().equals("역곡점")) {
					out.print(" selected=\"selected\"");
				}%>>역곡점</option>
										<option value="오리점" <%if (restaurant.getArea().equals("오리점")) {
					out.print(" selected=\"selected\"");
				}%>>오리점</option>
										<option value="용인점" <%if (restaurant.getArea().equals("용인점")) {
					out.print(" selected=\"selected\"");
				}%>>용인점</option>
										<option value="의정부점" <%if (restaurant.getArea().equals("의정부점")) {
					out.print(" selected=\"selected\"");
				}%>>의정부점</option>
										<option value="일산점" <%if (restaurant.getArea().equals("일산점")) {
					out.print(" selected=\"selected\"");
				}%>>일산점</option>
										<option value="죽전점" <%if (restaurant.getArea().equals("죽전점")) {
					out.print(" selected=\"selected\"");
				}%>>죽전점</option>
										<option value="파주문산점" <%if (restaurant.getArea().equals("파주문산점")) {
					out.print(" selected=\"selected\"");
				}%>>파주문산점</option>
										<option value="판교점" <%if (restaurant.getArea().equals("판교점")) {
					out.print(" selected=\"selected\"");
				}%>>판교점</option>
										<option value="평촌점" <%if (restaurant.getArea().equals("평촌점")) {
					out.print(" selected=\"selected\"");
				}%>>평촌점</option>
										<option value="평택비전점" <%if (restaurant.getArea().equals("평택비전점")) {
					out.print(" selected=\"selected\"");
				}%>>평택비전점</option>
										<option value="평택소사점" <%if (restaurant.getArea().equals("평택소사점")) {
					out.print(" selected=\"selected\"");
				}%>>평택소사점</option>
										<option value="화정점" <%if (restaurant.getArea().equals("화정점")) {
					out.print(" selected=\"selected\"");
				}%>>화정점</option>
									</optgroup>
								</select>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<div class="col-sm-10 offset-sm-10">
											<button class="btn btn-outline-primary" type="button" id="setMarker" style="bottom: 5px;">입력 완료</button>
										</div>
										<div class="map_wrap">
										...
										<input type="hidden" id="startLat" name="start_lat" value=""> <input type="hidden" id="startLon" name="start_lon" value="">
									</div>
								</div>
							</div>
						</div>

...
<div>
	...
	<form name="updatecomment" method="post">
		...
		<hr>
		<input type="button" value="취소" onclick="cancelUpdate()"> <input type="submit" value="수정" onclick="saveRestUpdate()">
		<%	} else { %>
		...
		<hr>
		<input type="button" value="취소" onclick="cancelUpdate()"> <input type="submit" value="수정" onclick="saveUpdate()">
		<%  } %>
	</form>
</div>

	...
	<div class="container pt-lg-md">
		<div class="row justify-content-center">
			<div class="col-lg-5">
					...
					<div class="card-body px-lg-5 py-lg-5">
						...
						<form role="form" name="loginForm" method="post" action="login_pro.jsp">
							...
							<div class="custom-control custom-control-alternative custom-checkbox">
								<input class="custom-control-input" type="checkbox" id="idCheck" name="saveId" <%if (userid.isEmpty() == false)
				out.print(" checked=\"checked\"");%>> <label class="custom-control-label" for="idCheck"> <span>Remember me</span></label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6">
						<a href="#" class="text-light" onclick="history.go(-1);">
							<small>Return to previous</small>
						</a>
					</div>
					<div class="col-6 text-right">
						<a href="signup_form.jsp" class="text-light">

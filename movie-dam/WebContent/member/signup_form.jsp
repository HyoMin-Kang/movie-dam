						...
						<form role="form" name="insertMember" method="post" action="signup_pro.jsp" onsubmit="return formSubmit();">
							...
							<div class="form-group">
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="inputGender1" name="mem_gender" value="0" class="custom-control-input"> <label class="custom-control-label" for="inputGender1">남성</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" id="inputGender2" name="mem_gender" value="1" class="custom-control-input"> <label class="custom-control-label" for="inputGender2">여성</label>
								</div>
							</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-0.png"> <img src="/movie-dam/assets/img/profile-img/man-0.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-1.png"> <img src="/movie-dam/assets/img/profile-img/man-1.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-2.png"> <img src="/movie-dam/assets/img/profile-img/man-2.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-3.png"> <img src="/movie-dam/assets/img/profile-img/man-3.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-4.png"> <img src="/movie-dam/assets/img/profile-img/man-4.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="man-5.png"> <img src="/movie-dam/assets/img/profile-img/man-5.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-0.png"> <img src="/movie-dam/assets/img/profile-img/woman-0.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-1.png"> <img src="/movie-dam/assets/img/profile-img/woman-1.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-2.png"> <img src="/movie-dam/assets/img/profile-img/woman-2.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-3.png"> <img src="/movie-dam/assets/img/profile-img/woman-3.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-4.png"> <img src="/movie-dam/assets/img/profile-img/woman-4.png" width="25%">
											</label>
											<label class="hide-radio">
												<input type="radio" name="selected_img" value="woman-5.png"> <img src="/movie-dam/assets/img/profile-img/woman-5.png" width="25%">
											</label>
										</div>
							...
							<div class="row my-4">
								<div class="col-12">
									<div class="custom-control custom-control-alternative custom-checkbox">
										<input class="custom-control-input" id="customCheckRegister" type="checkbox"> <label class="custom-control-label" for="customCheckRegister"> <span>I agree with the <a href="#">Privacy Policy</a></span>
										</label>
									</div>
								</div>
							</div>
...
<script>
	function idConfirm(userid) {
		...
		open(
				url,
				'아이디 중복 체크',
				'height=200, width=320, menubar=no, scrollbars=no, toolbar=no, location=no, status=no, resizable=no');
	}
</script>
